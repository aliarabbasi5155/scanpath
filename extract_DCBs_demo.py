...
if __name__ == '__main__':
    ...
    # Compute DCB
    img_path = './Website/1 COCOSearch18-images-TP 3101 target-present (TP) images (size: 1680x1050)/images/bottle/222bottle.jpg'
    high_feat, low_feat = get_DCBs(img_path, predictor)
    print(high_feat.shape, low_feat.shape)

    # Save the features for later use
    torch.save(high_feat, 'Google Drive/DCBs/HR/bottle/222bottle.pth.tar')
    torch.save(low_feat, 'Google Drive/DCBs/LR/bottle/222bottle.pth.tar')
